...
<main class="request-list">
    <div class="request-list__inner">
        ...
        <div class="request-list__tabs">
            <a
                href="{{ route('stamp_correction_requests.user.index', ['status' => 'pending']) }}"
            ...
            <a
                href="{{ route('stamp_correction_requests.user.index', ['status' => 'approved']) }}"
            ...
            <tbody>
                @foreach ($requests as $requestItem)
                    <tr>
                        ...
                        <td>
                            <a
                                href="{{ route('attendance.edit', ['id' => $requestItem->attendance_id]) }}"
